...
public class DBManager {
	...
	public void insertData(ArrayList<ArrayList> data) throws SQLException {

		database.execSQL("DELETE FROM " + Helper.TABLE_NAME);
		ContentValues values = new ContentValues();

		for (ArrayList arr : data) {
	...
	public Cursor selectMateria(){
		return Helper.getReadableDatabase().rawQuery("SELECT nm_materia as _id,"+DBHelper.MATERIA+", periodo"+" FROM " + DBHelper.TABLE_NAME, null);
	}
	
	public Cursor selectMateriaPeriodo(){
		return Helper.getReadableDatabase().rawQuery("SELECT nm_materia as _id,"+DBHelper.MATERIA+" FROM " + DBHelper.TABLE_NAME + 
